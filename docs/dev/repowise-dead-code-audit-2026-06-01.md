...
| --- | --- |
| DiscoverSpace renderer and remaining route-facing store exports | Visual engine helpers and store actions are imported by Svelte components, the route page, websocket handling, or contract tests. Exercise the DiscoverSpace surface before deleting anything beyond locally validated module-internal exports. |
